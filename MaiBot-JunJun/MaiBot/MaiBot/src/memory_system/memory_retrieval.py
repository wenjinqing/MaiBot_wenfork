...
**可用工具：**
1. 聊天记录查询工具 - 查询过往对话中的事件、话题、讨论内容
2. 人物信息查询工具 - 查询特定人物的信息、行为、关系
3. LPMM知识库查询 - 作为辅助信息源，当其他工具无法提供足够信息时使用

**执行策略：**
- 涉及过往事件或话题 → 使用聊天记录查询工具
- 涉及人物信息 → 使用人物信息查询工具
- 信息不足或不确定类别 → 可使用知识库查询作为补充
- 可以并行调用多个工具以提高效率
- 当收集到足够信息能明确回答问题时 → 调用 found_answer 工具

**思考要求：**
- 简短直接，切入要点
- 明确说明需要查询什么信息
- 如果信息充足，必须调用 found_answer 工具
""",
